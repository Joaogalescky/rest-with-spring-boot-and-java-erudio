package com.joaogalescky.integrationtests.repositories;
...
public class PersonRepositoryTest extends AbstractIntegrationTest {
	...
	public void testFindByName() throws JsonMappingException, JsonProcessingException {
		...
		person = repository.findPersonsByName("cés", pageable).getContent().get(0);
		...
		assertEquals("César", person.getFirstName());
		assertEquals("Lattes", person.getLastName());
		assertEquals("Curitiba", person.getAddress());
