...
import com.joaogalescky.services.BookServices;
...
public class BookController {
	...
	@Operation(summary = "Finds all book", description = "Finds all books", tags = { "Book" }, responses = {
	...
	@GetMapping(value = "/findsBooksByTitle/{title}", produces = { MediaType.APPLICATION_JSON,
			MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
	@Operation(summary = "Finds book by title", description = "Finds book by title", tags = {
